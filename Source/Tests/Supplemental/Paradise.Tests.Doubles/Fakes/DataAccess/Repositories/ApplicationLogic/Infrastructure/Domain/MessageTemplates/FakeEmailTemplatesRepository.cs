...
namespace Paradise.Tests.Doubles.Fakes.DataAccess.Repositories.ApplicationLogic.Infrastructure.Domain.MessageTemplates;
...
/// </param>
public sealed class FakeEmailTemplatesRepository(IDataSource source)
    : FakeRepositoryBase<EmailTemplate>(source), IEmailTemplatesRepository
{

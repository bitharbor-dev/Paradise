...
using Paradise.Tests.Doubles.Fakes.Microsoft.EntityFrameworkCore.Query;
using Paradise.Tests.Doubles.Fakes.System.Collections.Generic;

namespace Paradise.Tests.Doubles.Fakes.DataAccess;
...
public sealed class FakeDataSource(TimeProvider timeProvider) : IDataSource
{
    ...
    public IQueryable<TEntity> GetQueryable<TEntity>() where TEntity : class
    {
        ...
        var queryProvider = new FakeAsyncQueryProvider();
        var enumerable = new FakeAsyncEnumerable<TEntity>(entities, queryProvider);
        queryProvider.InnerQueryProvider = enumerable;

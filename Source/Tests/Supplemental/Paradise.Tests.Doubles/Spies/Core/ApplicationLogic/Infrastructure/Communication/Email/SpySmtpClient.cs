...
namespace Paradise.Tests.Doubles.Spies.Core.ApplicationLogic.Infrastructure.Communication.Email;
...
public sealed class SpySmtpClient : ISmtpClient
{
    ...
    public Task SendMailAsync(MailMessage message, CancellationToken cancellationToken)
    {
        ...
        {
            Attachments = message.Attachments.Select(a => new AttachmentModel(a.ContentStream, a.Name!, a.ContentType.MediaType)).ToList(),

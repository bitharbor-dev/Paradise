...
public sealed partial class SendPasswordChangeLinkTests
{
    ...
    #region Nested types
    /// <summary>
    /// Provides setup and behavior-check methods for the <see cref="SendPasswordChangeLinkTests"/> class.
    /// </summary>
    private sealed class TestEnvironment : IDisposable
    {
        ...
        /// System under test.
        /// </summary>
        public SendPasswordChangeLink Target { get; }
        ...
        /// <summary>
        /// Creates an email template used within the <see cref="SendPasswordChangeLink"/> class.
        /// </summary>
        private void CreateEmailTemplate()
        {
            var templateName = _emailTemplateOptions.PasswordChangeLinkTemplateName;

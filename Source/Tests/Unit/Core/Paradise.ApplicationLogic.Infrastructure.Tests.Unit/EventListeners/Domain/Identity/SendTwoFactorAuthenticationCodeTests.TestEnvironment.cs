...
public sealed partial class SendTwoFactorAuthenticationCodeTests
{
    ...
    private sealed class TestEnvironment : IDisposable
    {
        ...
        /// System under test.
        /// </summary>
        public SendTwoFactorAuthenticationCode Target { get; }
        ...
        /// <summary>
        /// Creates an email template used within the <see cref="SendTwoFactorAuthenticationCode"/> class.
        /// </summary>
        private void CreateEmailTemplate()
        {
            var templateName = _emailTemplateOptions.TwoFactorVerificationTemplateName;

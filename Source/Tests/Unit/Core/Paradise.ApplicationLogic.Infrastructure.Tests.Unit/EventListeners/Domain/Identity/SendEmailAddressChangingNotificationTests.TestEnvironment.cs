...
public sealed partial class SendEmailAddressChangingNotificationTests
{
    ...
    private sealed class TestEnvironment : IDisposable
    {
        ...
        /// System under test.
        /// </summary>
        public SendEmailAddressChangingNotification Target { get; }
        ...
        /// <summary>
        /// Creates an email template used within the <see cref="SendEmailAddressChangingNotification"/> class.
        /// </summary>
        private void CreateEmailTemplate()
        {
            var templateName = _emailTemplateOptions.EmailAddressChangingNotificationTemplateName;

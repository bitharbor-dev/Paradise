...
using Paradise.Tests.Doubles.Fakes.Core.ApplicationLogic.Infrastructure.Communication;
using Paradise.Tests.Doubles.Fakes.DataAccess;
using Paradise.Tests.Doubles.Fakes.DataAccess.Repositories;
...
public sealed partial class SendEmailAddressChangedNotificationTests
{
    ...
    #region Nested types
    /// <summary>
    /// Provides setup and behavior-check methods for the <see cref="SendEmailAddressChangedNotificationTests"/> class.
    /// </summary>
    private sealed class TestEnvironment : IDisposable
    {
        ...
        /// System under test.
        /// </summary>
        public SendEmailAddressChangedNotification Target { get; }
        ...
        /// <summary>
        /// Creates an email template used within the <see cref="SendEmailAddressChangedNotification"/> class.
        /// </summary>
        private void CreateEmailTemplate()
        {
            var templateName = _emailTemplateOptions.EmailAddressChangedNotificationTemplateName;
            var culture = null as CultureInfo;
            var templateText = "Test {p}0 {p}1";
            var subject = "Test";

            var emailTemplate = new EmailTemplate(templateName, culture, templateText, subject)
            {
                PlaceholderName = "{p}",
                PlaceholdersNumber = 2
            };

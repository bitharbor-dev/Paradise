...
public sealed partial class SendEmailAddressChangeLinkTests
{
    ...
    #region Nested types
    /// <summary>
    /// Provides setup and behavior-check methods for the <see cref="SendEmailAddressChangeLinkTests"/> class.
    /// </summary>
    private sealed class TestEnvironment : IDisposable
    {
        ...
        /// System under test.
        /// </summary>
        public SendEmailAddressChangeLink Target { get; }
        ...
        /// <summary>
        /// Creates an email template used within the <see cref="SendEmailAddressChangeLink"/> class.
        /// </summary>
        private void CreateEmailTemplate()
        {
            var templateName = _emailTemplateOptions.EmailAddressChangeLinkTemplateName;

...
/// <summary>
/// <see cref="ApplicationContext"/> test class.
/// </summary>
public sealed partial class ApplicationContextTests
{
    #region Public methods
    /// <summary>
    /// The <see cref="ApplicationContext.PreparePersistenceStorage"/> method should
    ...
    /// <summary>
    /// The <see cref="ApplicationContext.PreparePersistenceStorageAsync"/> method should
    /// create the database to operate over using the default model configuration.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// The <see cref="ApplicationContext.GetQueryable"/> method should
    ...
    /// <summary>
    /// The <see cref="ApplicationContext.DataProtectionKeys"/> property should

...
namespace Paradise.ApplicationLogic.Infrastructure.Services.Identity.Implementation;
...
/// Unit of work.
/// </param>
internal sealed class UserRefreshTokenService(TimeProvider timeProvider, IUserManager<User> userManager, IUnitOfWork unitOfWork)

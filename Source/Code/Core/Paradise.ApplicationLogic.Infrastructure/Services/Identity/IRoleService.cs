...
namespace Paradise.ApplicationLogic.Infrastructure.Services.Identity;
...
public interface IRoleService
{
    ...
    /// </returns>
    Task<Result<RoleModel>> GetByIdAsync(Guid id, CancellationToken cancellationToken = default);
    ...
    /// </returns>
    Task<Result<RoleModel>> UpdateAsync(Guid id, RoleUpdateModel model, CancellationToken cancellationToken = default);
    ...
    /// containing information about the application roles.
    /// </returns>
    Task<Result<IEnumerable<RoleModel>>> DeleteAsync(Guid id, CancellationToken cancellationToken = default);

...
namespace Paradise.ApplicationLogic.Infrastructure.Services.MessageTemplates.Implementation;
...
/// Unit of work.
/// </param>
internal sealed class EmailTemplateService(IUnitOfWork unitOfWork) : IEmailTemplateService
{

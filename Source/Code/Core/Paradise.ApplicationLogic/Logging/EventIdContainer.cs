...
using Paradise.ApplicationLogic.Logging.HighPerformance;
using static Paradise.ApplicationLogic.Logging.HighPerformance.LogMessagesDefinition;

namespace Paradise.ApplicationLogic.Logging;
...
/// </list>
/// </remarks>
internal static class EventIdContainer
{
    #region Properties
    /// <summary>
    /// Event id for <see cref="CriticalDatabaseSeedFailure"/>.
    /// </summary>
    public static EventId DatabaseSeedFailureLogEvent { get; } = new(55000, nameof(CriticalDatabaseSeedFailure));

    /// <summary>
    /// Event id for <see cref="CriticalDatabaseException"/>.
    /// </summary>
    public static EventId DatabaseExceptionLogEvent { get; } = new(55001, nameof(CriticalDatabaseException));

    /// <summary>
    /// Event id for <see cref="CriticalWorkerExecutionFailure"/>.
    /// </summary>
    public static EventId WorkerExecutionFailureLogEvent { get; } = new(55002, nameof(CriticalWorkerExecutionFailure));

    /// <summary>
    /// Event id for <see cref="InformationWorkerOptionsInitialState"/>.
    /// </summary>
    public static EventId WorkerOptionsInitialStateLogEvent { get; } = new(52000, nameof(InformationWorkerOptionsInitialState));

    /// <summary>
    /// Event id for <see cref="InformationWorkerOptionsChangedState"/>.
    /// </summary>
    public static EventId WorkerOptionsChangedStateLogEvent { get; } = new(52001, nameof(InformationWorkerOptionsChangedState));

    /// <summary>
    /// Event id for <see cref="ErrorResultErrors"/>.
    /// </summary>
    public static EventId ResultErrorsLogEvent { get; } = new(54000, nameof(ErrorResultErrors));

    /// <summary>
    /// Event id for <see cref="CriticalResultCriticalErrors"/>.
    /// </summary>
    public static EventId ResultCriticalErrorsLogEvent { get; } = new(55003, nameof(CriticalResultCriticalErrors));

    /// <summary>
    /// Event id for <see cref="InformationAddedSeedItem"/>.
    /// </summary>
    public static EventId AddedSeedItemLogEvent { get; } = new(52001, nameof(InformationAddedSeedItem));

    /// <summary>
    /// Event id for <see cref="InformationUpdatedSeedItem"/>.
    /// </summary>
    public static EventId UpdatedSeedItemLogEvent { get; } = new(52002, nameof(InformationUpdatedSeedItem));

    /// <summary>
    /// Event id for <see cref="InformationPendingDeletionUsersNumber"/>.
    /// </summary>
    public static EventId PendingDeletionUsersNumberLogEvent { get; } = new(52003, nameof(InformationPendingDeletionUsersNumber));

    /// <summary>
    /// Event id for <see cref="InformationOutdatedTokensNumber"/>.
    /// </summary>
    public static EventId OutdatedTokensNumberLogEvent { get; } = new(52004, nameof(InformationOutdatedTokensNumber));

    /// <summary>
    /// Event id for <see cref="InformationUnconfirmedUsersNumber"/>.
    /// </summary>
    public static EventId UnconfirmedUsersNumberLogEvent { get; } = new(52005, nameof(InformationUnconfirmedUsersNumber));

    /// <summary>
    /// Event id for <see cref="InformationWorkerRunning"/>.
    /// </summary>
    public static EventId WorkerRunningLogEvent { get; } = new(52006, nameof(InformationWorkerRunning));

    /// <summary>
    /// Event id for <see cref="WarningDatabaseEntrySeedFailure"/>.
    /// </summary>
    public static EventId DatabaseEntrySeedFailureLogEvent { get; } = new(53000, nameof(WarningDatabaseEntrySeedFailure));

    /// <summary>
    /// Event id for <see cref="CriticalClaimsAdditionFailure"/>.
    /// </summary>
    public static EventId ClaimsAdditionFailureLogEvent { get; } = new(55004, nameof(CriticalClaimsAdditionFailure));

    /// <summary>
    /// Event id for <see cref="CriticalUnhandledExceptionOccurred"/>.
    /// </summary>
    public static EventId UnhandledExceptionOccurredLogEvent { get; } = new(55005, nameof(CriticalUnhandledExceptionOccurred));

    /// <summary>
    /// Event id for <see cref="CriticalUnsuccessfulUserDeletionAfterFailedInvitation"/>.
    /// </summary>
    public static EventId UnsuccessfulUserDeletionAfterFailedInvitationLogEvent { get; } = new(55006, nameof(CriticalUnsuccessfulUserDeletionAfterFailedInvitation));
    #endregion
}
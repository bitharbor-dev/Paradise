...
/// </summary>
/// <remarks>
/// <strong>There is a convention for how to define a new event id:</strong>
/// <list type="number">
/// <item>
/// All numbers start from 5 to leave some capacity
/// for events logged from packages used by the application.
/// </item>
/// <item>
...
/// but the number 55 should be avoided
/// (apart from the first two digits)
/// to easily find critical errors in the logs.
/// </item>
/// </list>
/// <para>
/// <strong>Warning: always double-check event identifiers for duplicates when editing
/// and add unit tests for new event identifiers to lock the behavior.</strong>
/// </para>
/// </remarks>
public static class EventIdContainer
{
    ...
    /// </summary>
    public static LoggedEvent DatabaseSeedFailure { get; } = new(new(55_001, nameof(DatabaseSeedFailure)), LogLevel.Critical);

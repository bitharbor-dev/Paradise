...
/// <summary>
/// Contains runtime-defined actions to be executed while logging.
/// </summary>
public static class LogMessagesDefinition
{
    ...
    /// <summary>
    /// Gets an action to be executed while logging a database seed failure.
    /// </summary>
    ...
    /// <summary>
    /// Gets an action to be executed while logging an identity failure.
    /// </summary>

...
public static class IConfigurationExtensions
{
    ...
    /// <para>
    /// Fails on a non-existing configuration section.
    /// </para>
    /// </summary>
    /// <typeparam name="T">
    /// Instance type whose name is used as a section name.
    /// </typeparam>
    ...
    /// with the name of the <paramref name="instance"/> type name.
    /// <para>
    /// Skips a non-existing configuration section.
    /// </para>
    /// </summary>
    /// <typeparam name="T">
    /// Instance type whose name is used as a section name.
    ...
    public static T GetRequiredInstance<T>(this IConfiguration configuration)
    {
        ...
        if (instance is null)
        {
            var message = GetMessageFailedToCreateInstanceOfType<T>();

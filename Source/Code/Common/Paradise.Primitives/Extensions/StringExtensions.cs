...
public static class StringExtensions
{
    ...
    /// <summary>
    /// Checks whether the given <paramref name="emailAddress"/> is valid.
    /// </summary>
    ...
    /// <summary>
    /// Checks whether the given <paramref name="phoneNumber"/> is valid.
    /// </summary>
    ...
    /// <summary>
    /// Checks whether the given <paramref name="userName"/> is valid.
    /// </summary>
    /// <param name="userName">
    /// The user-name to be checked.
    /// </param>
    /// <param name="allowedCharacters">
    /// The list of characters allowed in the user name, used to
